                ...
                <li class="cart_item clearfix">
                    ...
                    <div class="cart_item_image"><img src="${image}" alt=""></div>
                     ...
                     <div class="value">
                            ...
                            <p class="total-itemsito" data-id="${id}"  class="cart_item_text" > ${currency}${count * unitCost
            } </p>
    </div>             
    ...
    Array.from(document.getElementsByClassName("total-itemsito")).forEach(
        (element) => {
            ...
            if (element.dataset.id === id) {
                ...
                element.innerHTML = `<p>${moneda}</p> <p class="costo-total-producto">${cantidad * precio_por_unidad
                    }</p>`;
            }
        }
    );
